...
const PriceTable2 = () => {
    ...
    const review = '4.9(20) reviews';
    const price = 34;
    const totalPerson = 3;
    const fromDate = '4/13/2020';
    const toDate = '4/17/2020';
    const daySpend = 4;
    ...
    // const priceUrl = `/${price}/${review}/${totalPerson}/${fromDate}/${toDate}/${daySpend}/${title}`;
    ...
    return (
        <div className="priceTable"> 
            ...
            {/* <Link to={priceUrl} className='reserve btn-block'>Reserve</Link> */}
